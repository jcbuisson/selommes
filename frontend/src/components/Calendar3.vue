...
// Normalize prop ranges so start/end are always Date objects
...
// Returns the prop ranges that include this date
function dayRanges(date) {
   const t = date.getTime()
   return normalizedRanges.value.filter(
